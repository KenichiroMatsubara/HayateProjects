...
This is a spec package, not a runtime. It is consumed transitively by Tsubame's protocol codegen (`@torimi/tsubame-protocol-generated`) rather than installed directly by app authors.
