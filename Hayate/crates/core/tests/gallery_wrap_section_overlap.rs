...
fn gallery_motion_heading_does_not_overlap_previous_card() {
    ...
    let section = mk!(&mut tree, ElementKind::View, &[
        StyleProp::Display(DisplayValue::Flex),
        StyleProp::FlexDirection(FlexDirectionValue::Column),
    ...
    let make_heading = |tree: &mut ElementTree, next: &mut u64, label: &str| -> (ElementId, ElementId) {
        ...
        let title = mk2(tree, ElementKind::Text, &[
    ...
    let cards = mk!(&mut tree, ElementKind::View, &[
        StyleProp::Display(DisplayValue::Flex),
    ...
    let chip_row = mk!(&mut tree, ElementKind::View, &[
        StyleProp::Display(DisplayValue::Flex),
        StyleProp::FlexDirection(FlexDirectionValue::Row),
        StyleProp::AlignItems(AlignValue::Center),
    ...
    let dot = mk!(&mut tree, ElementKind::View, &[
    ...
    let chip_title = mk!(&mut tree, ElementKind::Text, &[
    ...
    let body = mk!(&mut tree, ElementKind::View, &[
        StyleProp::Display(DisplayValue::Flex),
        StyleProp::FlexDirection(FlexDirectionValue::Column),
        StyleProp::Gap(Dimension::px(8.0)),
    ...
    let inner = mk!(&mut tree, ElementKind::View, &[
        StyleProp::Display(DisplayValue::Flex),
        StyleProp::FlexDirection(FlexDirectionValue::Column),
    ...
    let section2 = mk!(&mut tree, ElementKind::View, &[
        StyleProp::Display(DisplayValue::Flex),
        StyleProp::FlexDirection(FlexDirectionValue::Column),
        StyleProp::Gap(Dimension::px(14.0)),
    ]);
