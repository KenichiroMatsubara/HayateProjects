...
/**
 * App Bundle は内包する `@torimi/tsubame-renderer-hayate` の wire 定数バージョンを protocol version として
 * 埋める（#530 / CONTEXT.md「Protocol Version」）。バンドルが埋め込めるよう、renderer-hayate は
