...
This is a types/interface package. It is the only dependency of the composition root (`@torimi/tsubame-app`) and is pulled in transitively by the adapters and renderers rather than installed directly.
