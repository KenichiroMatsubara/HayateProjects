...
import { CanvasRenderer, PROTOCOL_VERSION } from '@tsubame/renderer-canvas';
import { App } from './App';
 ...
 * フレームワークも `@tsubame/renderer-canvas` も持たない。バンドル側（ここ）が **react** と
 * `CanvasRenderer` を持ち込み、ホストから渡された host bootstrap で App を mount する。
 *
...
// CanvasRenderer を結線する（host は両者を知らない）。
