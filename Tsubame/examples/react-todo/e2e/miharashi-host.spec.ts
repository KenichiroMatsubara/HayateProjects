...
/**
 * Miharashi の FW 非依存 e2e（#531 / ADR-0001）。solid（examples/todo）と**同じ FW 非依存ホスト**
 * （host.html / @miharashi/host-web）が、HTTP 配信された **react** App Bundle を fetch → eval し、
 ...
 * miharashi-host.spec）と同型の描画証明で本物の Chromium に対して確かめる。
 */
...
test.describe('Miharashi host — renders the HTTP-served react bundle', () => {
