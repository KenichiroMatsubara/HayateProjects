...
The wire contract between the Torimi dev server and the web host: the App Bundle route, the reload route, and the reload message. It is the single entry point that `@torimi/dev-server` and `@torimi/host-web` both reference as equals (ADR-0001).
